...
class PaymentSettingsConfigEntity extends Entity
{
    ...
    public function inflate(array $data): void
    {
        ...
        $this->paymentSettings = new PaymentSettings(PaymentAction::fromState($paymentSettingsData['paymentAction']), AutomaticCapture::create($paymentSettingsData['automaticCapture']), $paymentSettingsData['paymentAttemptsNumber'] ? PaymentAttemptsNumber::create($paymentSettingsData['paymentAttemptsNumber']) : null, $paymentSettingsData['applySurcharge'], $paymentSettingsData['paymentCapturedStatus'], $paymentSettingsData['paymentErrorStatus'], $paymentSettingsData['paymentPendingStatus'], $paymentSettingsData['paymentAuthorizedStatus'], $paymentSettingsData['paymentCancelledStatus'], $paymentSettingsData['paymentRefundedStatus'], $paymentSettingsData['template'], $paymentSettingsData['paymentPartiallyRefundedStatus'] ?? '', $paymentSettingsData['sendShoppingCart'] ?? \true, $paymentSettingsData['displayConfirmationPage'] ?? \true);
    }
