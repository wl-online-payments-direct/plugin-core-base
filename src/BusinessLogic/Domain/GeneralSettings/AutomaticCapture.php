...
class AutomaticCapture
{
    ...
    protected const SIXTEEN_HOURS = 960;
    protected const ONE_DAY = 1440;
    protected const TWO_DAYS = 2880;
    protected const THREE_DAYS = 4320;
    protected const FOUR_DAYS = 5760;
    ...
    {
        if (!in_array($value, [self::NEVER, self::ONE_HOUR, self::TWO_HOURS, self::FOUR_HOURS, self::EIGHT_HOURS, self::SIXTEEN_HOURS, self::ONE_DAY, self::TWO_DAYS, self::THREE_DAYS, self::FOUR_DAYS, self::FIVE_DAYS])) {
