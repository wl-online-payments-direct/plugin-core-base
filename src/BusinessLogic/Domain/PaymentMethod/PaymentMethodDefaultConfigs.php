...
class PaymentMethodDefaultConfigs
{
    ...
    public const EMBEDDED_CARDS = 'Embedded Cards';
    public const REDIRECTION_TO_CARDS = 'Redirection to Cards';
    ...
    public const IDEAL = 'iDEAL | Wero';
    public const ILLICADO = 'Illicado';
    public const INTERSOLVE = 'Intersolve';
    public const KLARNA = 'Klarna';
    public const KLARNA_PAY_LATER = 'Klarna Pay Later';
    public const KLARNA_FINANCING = 'Klarna Financing';
    public const KLARNA_BANK_TRANSFER = 'Klarna Bank Transfer';
    public const KLARNA_DIRECT_DEBIT = 'Klarna Direct Debit';
    public const KLARNA_PAY_WITH_KLARNA = 'Klarna Pay with Klarna';
    ...
    public const LINXO = 'Linxo Connect';
    // integration types
    ...
    public const PAY_BY_LINK_GROUP = 'payByLink';
    /**
