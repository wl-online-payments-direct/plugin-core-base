...
class CreditCard implements PaymentMethodAdditionalData
{
     ...
     */
    public function __construct(?TranslationCollection $vaultTitles, ?ThreeDSSettings $threeDSSettings = null, FlowType $type = null, bool $enableGroupCards = \true, ?AuthorizationMode $authorizationMode = null)
    {
