...
class PaymentMethodService
{
    ...
    /**
     * Mealvouchers requires only a customer email address. Guests are eligible as well, since the
     * merchant customer id is not mandatory for processing Mealvouchers payments.
     *
     * @param CartProvider $cartProvider
     * @return bool
     */
